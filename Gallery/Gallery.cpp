...
#include <chrono>  // for curr time 
#include <ctime>  // for curr time
...
void printSystemDetails(const std::string& name)
{
	//Get the current data and time
	auto timenow = std::chrono::system_clock::to_time_t(std::chrono::system_clock::now());
	std::cout << "Developed by: " << name << "." << std::endl;
	std::cout << "Started at: " << ctime(&timenow) << std::endl;
}
...
int main(void)
{
	...
	printSystemDetails("Gabriel Milshtein");
	std::cout << "===================" << std::endl;
